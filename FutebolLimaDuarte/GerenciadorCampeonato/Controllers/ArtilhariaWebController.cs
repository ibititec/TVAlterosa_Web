...
namespace GerenciadorCampeonato.Controllers
{
    public class ArtilhariaWebController : BaseController
    {
        ...
        public ArtilhariaWebController()
        {
            ...
            List<Artilharia_Web> listaArtilharia = artilhariaBusiness.ObterArtilharia();
           // listaJogador = listaJogador.Where(a => a.Id != listaArtilharia.Where(b => b.Id_Jogador == a.Id).First().Id_Jogador).ToList();
